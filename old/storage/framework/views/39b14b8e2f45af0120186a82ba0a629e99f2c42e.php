    ...
    <div class="row">
        <?php $__currentLoopData = $top_sell; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-4 col-sm-6 mt-2"
                 onclick="location.href='<?php echo e(route('admin.item.view',[$item['id']])); ?>'"
                 style="cursor: pointer;padding-right: 6px;padding-left: 6px">
                <div class="grid-card">
                    <label class="label_1"><?php echo e(translate('messages.sold')); ?> : <?php echo e($item['order_count']); ?></label>
                    ...
                    <div class="text-center mt-2">
                        <span class="" style="font-size: 10px"><?php echo e(Str::limit($item['name'],20,'...')); ?></span>
                    </div>
                </div>
            </div>
...
<!-- End Body -->
<?php /**PATH /home/crelocok/public_html/resources/views/admin-views/partials/_top-selling-foods.blade.php ENDPATH**/ ?>