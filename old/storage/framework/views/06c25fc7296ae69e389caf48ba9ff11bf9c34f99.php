                ...
                <div class="row pt-5">
                    <div class="col-md-12">
                        ...
                        <div class="text-center pt-3">
                            <!-- <a href="<?php echo e(env('APP_URL')); ?>" target="_blank" class="btn btn-info">Website Frontend</a> -->
                            <a href="<?php echo e(env('APP_URL')); ?>/admin/auth/login" target="_blank" class="btn btn-info">Admin
                                Panel</a>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.blank', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crelocok/public_html/resources/views/installation/step6.blade.php ENDPATH**/ ?>