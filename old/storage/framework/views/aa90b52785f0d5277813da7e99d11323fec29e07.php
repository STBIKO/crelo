...
<?php $__env->startSection('content'); ?>
    <div class="content container-fluid">
        ...
        <div class="card my-2">
            <div class="card-body">
                <form action="<?php echo e(route('admin.business-settings.landing-page-settings', 'feature')); ?>" method="POST"
                    ...
                    <div class="form-group">
                        <label class="input-label" for="feature_title"><?php echo e(translate('messages.feature_title')); ?></label>
                        <input type="text" id="feature_title" name="feature_title" class="form-control"
                            placeholder="Feature title">
                    </div>
                    <div class="form-group">
                        <label class="input-label"
                            for="feature_description"><?php echo e(translate('messages.feature_description')); ?></label>
                        <textarea placeholder="Feature description" name="feature_description" class="form-control" cols="30"
                            rows="10"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="input-label"><?php echo e(translate('messages.feature_img')); ?><small style="color: red">* (
                                <?php echo e(translate('messages.size')); ?>: 140 X 140 px )</small></label>
                    ...
                    <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?php echo e(translate('messages.feature_title')); ?></th>
                                <th scope="col"><?php echo e(translate('messages.feature_description')); ?></th>
                                <th scope="col"><?php echo e(translate('messages.action')); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if($feature): ?>
                                <?php $__currentLoopData = $feature; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $feature_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <th scope="row"><?php echo e($key + 1); ?></th>
                                        <td>
                                            <div class="media align-items-center">
                                                <img class="avatar avatar-lg mr-3"
                                                    src="<?php echo e(asset('public/assets/landing/image')); ?>/<?php echo e($feature_item['img']); ?>"
                                                    onerror="this.src='<?php echo e(asset('public/assets/admin/img/160x160/img2.jpg')); ?>'"
                                                    alt="<?php echo e($feature_item['title']); ?>">
                                            </div>
                                        </td>
                                        <td><?php echo e($feature_item['title']); ?></td>

                                        <td><?php echo e(Str::limit($feature_item['feature_description'], 100)); ?></td>
                                        <td>
                                            <a class="btn btn-sm btn-white" href="javascript:"
                                                onclick="form_alert('feature-<?php echo e($key); ?>','<?php echo e(translate('messages.Want_to_delete_this_item')); ?>')"
                                                title="<?php echo e(translate('messages.delete')); ?>"><i class="tio-delete-outlined"></i>
                                            </a>
                                            <form
                                                action="<?php echo e(route('admin.business-settings.landing-page-settings-delete', ['tab' => 'feature', 'key' => $key])); ?>"
                                                method="post" id="feature-<?php echo e($key); ?>">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crelocok/public_html/resources/views/admin-views/business-settings/landing-page-settings/feature.blade.php ENDPATH**/ ?>