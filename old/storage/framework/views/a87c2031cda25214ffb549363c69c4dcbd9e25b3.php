            ...
            <div class="d-flex align-items-center">
                <span class="h3 mb-0">
                    ...
                    <?php echo e(translate('messages.total_sell')); ?> : <?php echo e(\App\CentralLogics\Helpers::format_currency(array_sum($total_sell))); ?>
                      ...
                      <label style="font-size: 10px" class="badge badge-soft-primary">( Zone : <?php echo e($zone_name); ?> )</label>
                </span>
            </div>
...
<?php /**PATH /home/crelocok/public_html/resources/views/admin-views/partials/_monthly-earning-graph.blade.php ENDPATH**/ ?>