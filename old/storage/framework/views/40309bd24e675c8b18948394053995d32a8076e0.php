...
<head>
    ...
    <style>
        ...
        .dropdown-menu.show,
        .top-nav-bg {
            background-color: <?php echo e(isset($background_Change['header-bg']) ? $background_Change['header-bg'] : '#02592f'); ?>;
        }

        .footer-bg {
            background-color: <?php echo e(isset($background_Change['footer-bg']) ? $background_Change['footer-bg'] : '#57665F'); ?>;
        }
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-bolder active-nav"
                            href="<?php echo e(route('home')); ?>"><?php echo e(translate('messages.home')); ?><span
                                class="sr-only">(current)</span></a>
                    </li>
                    <?php if($landing_page_links['web_app_url_status']): ?>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="<?php echo e($landing_page_links['web_app_url']); ?>"><?php echo e(translate('messages.browse_web')); ?></a>
                        </li>
                    <?php endif; ?>
                    <li class="nav-item">
                        <a class="nav-link"
                            href="<?php echo e(route('terms-and-conditions')); ?>"><?php echo e(translate('messages.terms_and_condition')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('about-us')); ?>"><?php echo e(translate('messages.about_us')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                            href="<?php echo e(route('contact-us')); ?>"><?php echo e(translate('messages.contact_us')); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                            href="<?php echo e(route('privacy-policy')); ?>"><?php echo e(translate('messages.privacy_policy')); ?></a>
                    </li>
                    <?php if($toggle_dm_registration || $toggle_store_registration): ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                <?php echo e(translate('messages.join_us')); ?>
                                ...
                                <?php if($toggle_store_registration): ?>
                                    <li>
                                        <a class="dropdown-item" href="<?php echo e(route('restaurant.create')); ?>">
                                            <?php echo e(translate('messages.store_registration')); ?>
        ...
        <div class="container">
            ...
            <?php else: ?>
                col-md-3 <?php endif; ?> footer-col">
                    ...
                    <h5 class="text-white mb-3"><?php echo e(translate('messages.quick_links')); ?></h5>
                    <ul class="list-unstyled text-muted">
                        <li>
                            <a href="<?php echo e(route('about-us')); ?>"><?php echo e(translate('messages.about_us')); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('contact-us')); ?>"><?php echo e(translate('messages.contact_us')); ?></a>
                        </li>
                        <li>
                ...
                <?php if($landing_page_links['app_url_android_status'] !== null || $landing_page_links['app_url_ios_status'] !== null): ?>
                    <div class="col-md-3 footer-col">
                        <h5 class="text-white mb-3"><?php echo e(translate('messages.download_our_apps')); ?></h5>
                ...
                <?php else: ?>
                    col-md-3 <?php endif; ?> footer-col">
                    <h5 class="text-white mb-2"><?php echo e(translate('messages.contact_us')); ?></h5>
...
<?php /**PATH /home/crelocok/public_html/resources/views/layouts/landing/app.blade.php ENDPATH**/ ?>