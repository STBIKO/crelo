    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-9">
                    <h1 class="page-header-title text-capitalize"><?php if($parcel_order): ?> <?php echo e(translate('messages.parcel')); ?> <?php echo e(translate('messages.orders')); ?> <?php else: ?> <?php echo e(str_replace('_',' ',$status)); ?> <?php echo e(translate('messages.orders')); ?> <?php endif; ?> <span class="badge badge-soft-dark ml-2"><?php echo e($total); ?></span></h1>
                </div>
                <div class="col-3">
                    <?php if(!$parcel_order): ?>
                    <select name="zone_id" class="form-control js-select2-custom"
                            onchange="set_filter('<?php echo e(url()->full()); ?>',this.value,'module_id')" title="<?php echo e(translate('messages.select')); ?> <?php echo e(translate('messages.modules')); ?>">
                                ...
                                <div id="showHideDropdown"
                                    ...
                                    <div class="card card-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <span class="mr-2 text-capitalize"><?php echo e(translate('messages.payment')); ?> <?php echo e(translate('messages.status')); ?></span>
                ...
                <table id="datatable"
                    ...
                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="status-<?php echo e($order['order_status']); ?> class-all">
                            ...
                            <td>
                                <?php if($parcel_order): ?>
                                    <label class="badge badge-soft-primary"><?php echo e(Str::limit($order->parcel_category?$order->parcel_category->name:translate('messages.not_found'),20,'...')); ?></label>
                                <?php elseif($order->store): ?>
                                    <label class="badge badge-soft-primary"><a href="<?php echo e(route('admin.vendor.view', $order->store_id)); ?>" alt="view store"><?php echo e(Str::limit($order->store?$order->store->name:translate('messages.store deleted!'),20,'...')); ?></a></label>
                                <?php else: ?>
                                    <label class="badge badge-soft-danger"><?php echo e(Str::limit(translate('messages.not_found'),20,'...')); ?></label>
                                <?php endif; ?>
                            </td>
                            <td>
                            ...
                            <td class="text-capitalize">
                                ...
                                <?php elseif($order['order_status']=='failed'): ?>
                                    <span class="badge badge-soft-danger ml-2 ml-sm-3">
                                      <span class="legend-indicator bg-danger text-capitalize"></span><?php echo e(translate('messages.payment')); ?>  <?php echo e(translate('messages.failed')); ?>
                            ...
                            <td class="text-capitalize">
                                <?php if($order['order_type']=='take_away'): ?>
                                    <span class="badge badge-soft-dark ml-2 ml-sm-3">
                                        <span class="legend-indicator bg-dark"></span><?php echo e(translate('messages.take_away')); ?>
                            ...
                            <td>
                                <a class="btn btn-sm btn-white"
                                           href="<?php echo e(route($parcel_order?'admin.parcel.order.details':'admin.order.details',['id'=>$order['id']])); ?>"><i
            ...
            <div class="card card-lg sidebar-card sidebar-footer-fixed">
                ...
                <form class="card-body sidebar-body sidebar-scrollbar" action="<?php echo e(route('admin.order.filter')); ?>" method="POST" id="order_filter_form">
                    ...
                    <div class="custom-control custom-radio mb-2">
                        ...
                        <label class="custom-control-label" for="orderStatus6"><?php echo e(translate('messages.returned')); ?></label>
                    </div>
                    <div class="custom-control custom-radio mb-2">
            ...
            var datatable = $.HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        {
                            window.location.href = '<?php echo e(route("admin.order.export",['status'=>$status,'file_type'=>'excel','type'=>$parcel_order?'parcel':'order'])); ?>';
                        }
                    },
                    {
                        extend: 'csv',
                        ...
                        action: function (e, dt, node, config)
                        {
                            window.location.href = '<?php echo e(route("admin.order.export",['status'=>$status,'file_type'=>'csv','type'=>$parcel_order?'parcel':'order'])); ?>';
                        }
                    },
                    // {
                    //     extend: 'pdf',
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crelocok/public_html/resources/views/admin-views/order/list.blade.php ENDPATH**/ ?>