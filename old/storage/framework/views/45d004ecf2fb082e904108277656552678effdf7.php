    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center mb-3">
                <div class="col-9">
                    <h1 class="page-header-title text-capitalize"><?php echo e(translate('messages.'.$status)); ?> <?php echo e(translate('messages.orders')); ?> <span
                ...
                <table id="datatable"
                    ...
                    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="status-<?php echo e($order['order_status']); ?> class-all">
                            ...
                            <td>
                                <label class="badge badge-soft-primary"><?php echo e($order->store?$order->store->name:'Restaurant deleted!'); ?></label>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-white" target="_blank"
                                           href="<?php echo e(route('admin.order.generate-invoice',[$order['id']])); ?>"><i
                                                class="tio-download"></i> <?php echo e(translate('messages.invoice')); ?></a>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crelocok/public_html/resources/views/admin-views/order/distaptch_list.blade.php ENDPATH**/ ?>