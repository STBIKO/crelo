        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-capitalize"><?php echo e(translate('messages.business')); ?> <?php echo e(translate('messages.setup')); ?>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="<?php echo e(route('admin.business-settings.update-setup')); ?>" method="post"
                    ...
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1"><?php echo e(translate('messages.business')); ?>

                            <?php echo e(translate('messages.name')); ?></label>
                        <input type="text" name="store_name" value="<?php echo e($name->value ?? ''); ?>" class="form-control"
                            placeholder="<?php echo e(translate('messages.new_business')); ?>" required>
                    </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label"
                                    for="exampleFormControlInput1"><?php echo e(translate('messages.currency')); ?></label>
                            ...
                            <div class="form-group">
                                ...
                                <select name="currency_symbol_position" class="form-control js-select2-custom"
                                    ...
                                    <option value="left"
                                        ...
                                        <?php echo e(translate('messages.left')); ?> (<?php echo e(\App\CentralLogics\Helpers::currency_symbol()); ?>123)
                                    </option>
                                    <option value="right"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label class="input-label"
                                    for="exampleFormControlInput1"><?php echo e(translate('messages.language')); ?> </label>
                                <select name="language[]" id="language" data-maximum-selection-length="3"
                                    ...
                                    title="<?php echo e(translate('messages.add_language_warrning')); ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline text-capitalize"><?php echo e(translate('messages.time_zone')); ?></label>
                                <select name="timezone" class="form-control js-select2-custom">
                                    ...
                                    <option value="US/Alaska" <?php echo e($tz ? ($tz == 'US/Alaska' ? 'selected' : '') : ''); ?>>(GMT-09:00)
                                        Alaska</option>
                                    <option value="America/Los_Angeles"
                                        <?php echo e($tz ? ($tz == 'America/Los_Angeles' ? 'selected' : '') : ''); ?>>(GMT-08:00) Pacific Time
                                        (US & Canada)</option>
                                    ...
                                    <option value="America/Mexico_City"
                                        <?php echo e($tz ? ($tz == 'America/Mexico_City' ? 'selected' : '') : ''); ?>>(GMT-06:00) Guadalajara,
                                        Mexico City, Monterrey</option>
                                    <option value="Canada/Saskatchewan"
                                        <?php echo e($tz ? ($tz == 'Canada/Saskatchewan' ? 'selected' : '') : ''); ?>>(GMT-06:00) Saskatchewan
                                    </option>
                                    ...
                                    <option value="Canada/Newfoundland"
                                        <?php echo e($tz ? ($tz == 'Canada/Newfoundland' ? 'selected' : '') : ''); ?>>(GMT-03:30) Newfoundland
                                    </option>
                                    <option value="America/Sao_Paulo"
                                        <?php echo e($tz ? ($tz == 'America/Sao_Paulo' ? 'selected' : '') : ''); ?>>(GMT-03:00) Brasilia</option>
                                    <option value="America/Argentina/Buenos_Aires"
                                        <?php echo e($tz ? ($tz == 'America/Argentina/Buenos_Aires' ? 'selected' : '') : ''); ?>>(GMT-03:00)
                                    ...
                                    <option value="America/Montevideo"
                                        <?php echo e($tz ? ($tz == 'America/Montevideo' ? 'selected' : '') : ''); ?>>(GMT-03:00) Montevideo
                                    </option>
                                    <option value="America/Noronha" <?php echo e($tz ? ($tz == 'America/Noronha' ? 'selected' : '') : ''); ?>>
                                        (GMT-02:00) Mid-Atlantic</option>
                                    <option value="Atlantic/Cape_Verde"
                                        <?php echo e($tz ? ($tz == 'Atlantic/Cape_Verde' ? 'selected' : '') : ''); ?>>(GMT-01:00) Cape Verde Is.
                                    </option>
                                    ...
                                    <option value="Asia/Baku" <?php echo e($tz ? ($tz == 'Asia/Baku' ? 'selected' : '') : ''); ?>>(GMT+04:00)
                                        Baku</option>
                                    ...
                                    <option value="Asia/Yekaterinburg"
                                        <?php echo e($tz ? ($tz == 'Asia/Yekaterinburg' ? 'selected' : '') : ''); ?>>(GMT+05:00) Yekaterinburg
                                    </option>
                                    ...
                                    <option value="Asia/Kuala_Lumpur"
                                        <?php echo e($tz ? ($tz == 'Asia/Kuala_Lumpur' ? 'selected' : '') : ''); ?>>(GMT+08:00) Kuala Lumpur,
                                        Singapore</option>
                                    ...
                                    <option value="Australia/Adelaide"
                                        <?php echo e($tz ? ($tz == 'Australia/Adelaide' ? 'selected' : '') : ''); ?>>(GMT+09:30) Adelaide
                                    </option>
                                    <option value="Australia/Darwin" <?php echo e($tz ? ($tz == 'Australia/Darwin' ? 'selected' : '') : ''); ?>>
                                        (GMT+09:30) Darwin</option>
                                    <option value="Australia/Brisbane"
                                        <?php echo e($tz ? ($tz == 'Australia/Brisbane' ? 'selected' : '') : ''); ?>>(GMT+10:00) Brisbane
                                    </option>
                                    <option value="Australia/Canberra"
                                        <?php echo e($tz ? ($tz == 'Australia/Canberra' ? 'selected' : '') : ''); ?>>(GMT+10:00) Canberra,
                                    ...
                                    <option value="Pacific/Tongatapu"
                                        <?php echo e($tz ? ($tz == 'Pacific/Tongatapu' ? 'selected' : '') : ''); ?>>(GMT+13:00) Nuku'alofa
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline text-capitalize"><?php echo e(translate('messages.time_format')); ?></label>
                                <select name="time_format" class="form-control">
                                    <option value="12" <?php echo e($tf == '12' ? 'selected' : ''); ?>><?php echo e(translate('messages.12_hour')); ?>

                                    </option>
                                    <option value="24" <?php echo e($tf == '24' ? 'selected' : ''); ?>><?php echo e(translate('messages.24_hour')); ?>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(translate('messages.scheduled')); ?>

                                    <?php echo e(translate('messages.orders')); ?></label><small style="color: red">
                                    <!-- <span class="input-label-secondary" title="<?php echo e(translate('messages.customer_varification_toggle')); ?>"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.customer_varification_toggle')); ?>"></span> -->
                                    *
                                </small>
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1" name="schedule_order"
                                                id="schedule_order" <?php echo e($schedule_order == 1 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="schedule_order"><?php echo e(translate('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0" name="schedule_order"
                                                id="schedule_order2" <?php echo e($schedule_order == 0 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="schedule_order2"><?php echo e(translate('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-sm-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline"><?php echo e(translate('messages.order_confirmation_model')); ?></label><small
                                    style="color: red">
                                    <span class="input-label-secondary"
                                        title="<?php echo e(translate('messages.order_confirmation_model_hint')); ?>"><img
                                            src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="order_confirmation_model"><?php echo e(translate('messages.store')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="order_confirmation_model2"><?php echo e(translate('messages.deliveryman')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-sm-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(translate('dm_tips_status')); ?></label><small
                                    style="color: red">
                                    <span class="input-label-secondary"
                                        title="<?php echo e(__('messages.dm_tips_model_hint')); ?>"><img
                                            src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="dm_tips_status"><?php echo e(translate('on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                ...
                                                <?php echo e($dm_tips_status == '0' ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="dm_tips_manage2"><?php echo e(translate('off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline"><?php echo e(translate('messages.store_cancellation_toggle')); ?></label><small
                                    style="color: red">
                                    <!-- <span class="input-label-secondary" title="<?php echo e(translate('messages.customer_varification_toggle')); ?>"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.customer_varification_toggle')); ?>"></span> -->
                                    *
                                </small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="canceled_by_store"><?php echo e(translate('messages.yes')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="canceled_by_store2"><?php echo e(translate('messages.no')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline"><?php echo e(translate('messages.deliveryman_cancellation_toggle')); ?></label><small
                                    style="color: red">
                                    <!-- <span class="input-label-secondary" title="<?php echo e(translate('messages.customer_varification_toggle')); ?>"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.customer_varification_toggle')); ?>"></span> -->
                                    *
                                </small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="canceled_by_deliveryman"><?php echo e(translate('messages.yes')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="canceled_by_deliveryman2"><?php echo e(translate('messages.no')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline"><?php echo e(translate('messages.show_earning_for_each_order')); ?></label><small
                                    style="color: red">
                                    <!-- <span class="input-label-secondary" title="<?php echo e(translate('messages.customer_varification_toggle')); ?>"><img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>" alt="<?php echo e(translate('messages.customer_varification_toggle')); ?>"></span> -->
                                    *
                                </small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="show_dm_earning"><?php echo e(translate('messages.yes')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                ...
                                                <?php echo e($show_dm_earning == 0 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="show_dm_earning2"><?php echo e(translate('messages.no')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(translate('messages.admin')); ?>

                                    <?php echo e(translate('messages.order')); ?> <?php echo e(translate('messages.notification')); ?></label><small
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="aon1"><?php echo e(translate('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                ...
                                                <?php echo e($admin_order_notification == 0 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="aon2"><?php echo e(translate('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(translate('messages.customer')); ?>

                                    <?php echo e(translate('messages.verification')); ?></label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="<?php echo e(translate('messages.customer_varification_toggle')); ?>"><img
                                            src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                            alt="<?php echo e(translate('messages.customer_varification_toggle')); ?>"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="customer_verification" id="ev1" <?php echo e($ev == 1 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label" for="ev1"><?php echo e(translate('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="customer_verification" id="ev2" <?php echo e($ev == 0 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="ev2"><?php echo e(translate('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(translate('messages.order')); ?>

                                    <?php echo e(translate('messages.delivery')); ?> <?php echo e(translate('messages.verification')); ?></label><small
                                    style="color: red"><span class="input-label-secondary"
                                        title="<?php echo e(translate('messages.order_varification_toggle')); ?>"><img
                                            src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                            alt="<?php echo e(translate('messages.order_varification_toggle')); ?>"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1" name="odc" id="odc1"
                                                <?php echo e($odc == 1 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="odc1"><?php echo e(translate('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0" name="odc" id="odc2"
                                                <?php echo e($odc == 0 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="odc2"><?php echo e(translate('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline"><?php echo e(translate('messages.veg')); ?>/<?php echo e(translate('messages.non_veg')); ?></label><small
                                    style="color: red"><span class="input-label-secondary"
                                        title="<?php echo e(translate('messages.veg_non_veg')); ?>"><img
                                            src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                            alt="<?php echo e(translate('messages.order_varification_toggle')); ?>"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="vnv1"><?php echo e(translate('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0" name="vnv" id="vnv2"
                                                <?php echo e($vnv == 0 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="vnv2"><?php echo e(translate('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline"><?php echo e(translate('messages.store_self_registration')); ?></label><small
                                    style="color: red"><span class="input-label-secondary"
                                        title="<?php echo e(translate('messages.store_self_registration')); ?>"><img
                                            src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                            alt="<?php echo e(translate('messages.store_self_registration')); ?>"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="store_self_registration1"><?php echo e(translate('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                ...
                                                <?php echo e($store_self_registration == 0 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="store_self_registration2"><?php echo e(translate('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline"><?php echo e(translate('messages.dm_self_registration')); ?></label><small
                                    style="color: red"><span class="input-label-secondary"
                                        title="<?php echo e(translate('messages.dm_self_registration')); ?>"><img
                                            src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                            alt="<?php echo e(translate('messages.dm_self_registration')); ?>"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="dm_self_registration1"><?php echo e(translate('messages.on')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                ...
                                                <?php echo e($dm_self_registration == 0 ? 'checked' : ''); ?>>
                                            <label class="custom-control-label"
                                                for="dm_self_registration2"><?php echo e(translate('messages.off')); ?></label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group p-2">
                                ...
                                <input type="number" name="digit_after_decimal_point" class="form-control"
                                    ...
                                    value="<?php echo e($digit_after_decimal_point ? $digit_after_decimal_point->value : 0); ?>" min="0"
                                    max="4" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group p-2">
                                <label class="input-label text-capitalize"
                                    for="admin_commission"><?php echo e(translate('messages.default_admin_commission')); ?></label>
                                <input type="number" name="admin_commission" class="form-control" id="admin_commission"
                                    value="<?php echo e($admin_commission ? $admin_commission->value : 0); ?>" min="0" max="100" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group p-2 border">
                                <label class="input-label d-inline text-capitalize"
                                    for="free_delivery_over"><?php echo e(translate('messages.free_delivery_over')); ?>
                                ...
                                <input type="number" name="free_delivery_over" class="form-control"
                                    id="free_delivery_over" value="<?php echo e($free_delivery_over ? $free_delivery_over->value : 0); ?>"
                                    min="0" step=".01" required <?php echo e(isset($free_delivery_over->value) ? '' : 'readonly'); ?>>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="minimum_shipping_charge" class="form-control"
                                    ...
                                    value="<?php echo e($minimum_shipping_charge ? $minimum_shipping_charge->value : 0); ?>" required>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="per_km_shipping_charge" class="form-control"
                                    ...
                                    value="<?php echo e($per_km_shipping_charge ? $per_km_shipping_charge->value : 0); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline text-capitalize"
                                    for="dm_maximum_orders"><?php echo e(translate('messages.dm_maximum_order')); ?></label><small
                                    style="color: red"><span class="input-label-secondary"
                                        title="<?php echo e(translate('messages.dm_maximum_order_hint')); ?>"><img
                                            src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                            alt="<?php echo e(translate('messages.dm_maximum_order_hint')); ?>"></span> *</small>
                                <input type="number" name="dm_maximum_orders" class="form-control" id="dm_maximum_orders"
                                    min="1" value="<?php echo e($dm_maximum_orders ? $dm_maximum_orders->value : 1); ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo e($phone->value ?? ''); ?>" name="phone" class="form-control"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="email" value="<?php echo e($email->value ?? ''); ?>" name="email" class="form-control"
                                    placeholder="" required>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <label class="input-label text-capitalize d-inline"
                                    for="latitude"><?php echo e(translate('messages.latitude')); ?><span class="input-label-secondary"
                                        title="<?php echo e(translate('messages.click_on_the_map_select_your_defaul_location')); ?>"><img
                                            src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <?php ($logo = $logo->value ?? ''); ?>
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(translate('messages.logo')); ?></label><small
                                    style="color: red">* ( <?php echo e(translate('messages.ratio')); ?> 3:1 )</small>
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php ($icon = $icon->value ?? ''); ?>
                            <div class="form-group">
                                <label class="input-label d-inline"><?php echo e(translate('messages.Fav Icon')); ?></label><small
                                    style="color: red">* ( <?php echo e(translate('messages.ratio')); ?> 1:1 )</small>
                                <div class="custom-file mb-3">
                                    <input type="file" name="icon" id="favIconUpload" class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label" for="favIconUpload"><?php echo e(translate('messages.choose')); ?>
                                ...
                                <center>
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;" id="iconViewer"
                                        onerror="this.src='<?php echo e(asset('public/assets/admin/img/160x160/img2.jpg')); ?>'"
                                        src="<?php echo e(asset('storage/app/public/business/' . $icon)); ?>" alt="Fav icon" />
                                </center>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crelocok/public_html/resources/views/admin-views/business-settings/business-index.blade.php ENDPATH**/ ?>