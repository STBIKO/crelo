        ...
        <div class="container">
            <div class="row hero-content-main">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <img src="<?php echo e(asset('public/assets/landing')); ?>/image/<?php echo e(isset($landing_page_images['top_content_image'])?$landing_page_images['top_content_image']:'double_screen_image.png'); ?>" 
                        onerror="this.src='<?php echo e(asset('public/assets/landing/image/double_screen_image.png')); ?>'}}'"
                        alt="Image One"
            ...
            <div class="row about-section-row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 about-us-right-column">
                    <div class="about-us__right animate__animated animate__backInRight">
                        <h3><?php echo e(translate('messages.about_us')); ?></h3>
                        ...
                        <a href="<?php echo e(route('about-us')); ?>"
                            class="btn btn-lg read-more mt-4"><?php echo e(translate('messages.read_more')); ?></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 col-sm-12 mb-5 stuning-feature">
                        <div class="service-left animate__animated animate__backInLeft">
                            <h2 class="section-heading"><?php echo e(isset($landing_page_text['feature_section_title']) ? $landing_page_text['feature_section_title'] :translate('messages.our_features')); ?></h2>
                            <p class="stuning-p">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 our-app-text-box">
                        <div class="about-us-right align-center">
                            <h3><?php echo e(translate('messages.our_mobile_applications')); ?></h3>
        ...
        <div class="container">
            <div class="subscription">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <h2 class="news-letter-heading"><?php echo e(translate('messages.news_letter_signup')); ?></h2>
                        <p class="news-letter-text">

                            <?php echo e(translate('messages.news_letter_signup_text')); ?>
                        ...
                        <?php $__currentLoopData = $testimonial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col owl-item">
                                <div class="testimonial">
                                    <div class="pic">
                                        <img class="img-fluid" src="<?php echo e(asset('public/assets/landing')); ?>/image/<?php echo e($data['img']); ?>"
                                            alt="Image">
                                    </div>
...
<?php echo $__env->make('layouts.landing.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crelocok/public_html/resources/views/home.blade.php ENDPATH**/ ?>